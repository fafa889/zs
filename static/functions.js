    ...
    darkMode: function () {
        ...
        if (e.isVariableDefined(dark)) {
          ...
          var changeThemeToDark = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', '/static/new_css/style-dark-rtl.css');
            } else {
                style.setAttribute('href', '/static/new_css/style-dark.css');
            }
          ...
          var changeThemeToLight = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', '/static/new_css/style-rtl.css');
            } else {
                style.setAttribute('href', '/static/new_css/style-light.css');
            }
